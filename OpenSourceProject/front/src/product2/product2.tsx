...
import reviewsData from './product2review.json';
            ...
            <div className={styles.container}>
                <div className={styles.mainContent}>
                    <div className={styles.productInfo}>
                        <h1 className={styles.productName}>빙그레 더 단백 드링크 초코 250ml x 36개</h1>
                        <h2 className={styles.productCompany}>빙그레</h2>
                        <div className={styles.productImageSection}>
                            <img id="product-image" className={styles.productImage} src="https://sitem.ssgcdn.com/26/11/18/item/2097001181126_i1_1200.jpg" alt="제품 이미지" ref={productImageRef} />
                            ...
                            <div className={styles.subImages} ref={el => subImagesRef.current = el?.querySelectorAll('img') || null}>
                                <img src="https://sitem.ssgcdn.com/26/11/18/item/2097001181126_i1_1200.jpg" alt="서브 이미지 1" />
                                <img src="https://thumbnail8.coupangcdn.com/thumbnails/remote/230x230ex/image/retail/images/2008566164289117-ac04ecea-1a86-4a46-a5ce-69d4e12e478a.png" alt="서브 이미지 2" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className={styles.reviewNewsSection}>
                    <div className={styles.reviewSection}>
                        ...
                        <div id="reviews">
                            <p className={styles.review}>"맛이 진하고 부드럽다"</p>
                            <p className={styles.review}>"비릿한 맛이 느껴지지 않는다"</p>
                            <p className={styles.review}>"거부감 없이 마실 수 있다"</p>
                        </div>
                    ...
                    <div className={styles.relatedNews}>
                        ...
                        <ul id="news-list" className={styles.newsList}>
                            <li>
                                <a href="https://www.news2day.co.kr/article/20240304500069" id="news1" className={styles.newsItem}>
                                    <img src = "https://cdn.news2day.co.kr/data2/content/image/2024/03/04/.cache/512/20240304500054.jpg" alt="뉴스 이미지 1" className={styles.newsImage} />
                                    <div className={styles.newsContent}>
                                        <span className={styles.newsTitle}>빙그레, ‘더:단백’ 신제품 추가 출시, 단백질 음료 라인업 확대</span>
                                        <p className={styles.newsDescription}>단백질 음료 시장에서 영역 확장 나서</p>
                                        <span className={styles.newsSource}>뉴스투데이</span>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.thinkfood.co.kr/news/articleView.html?idxno=97747" id="news2" className={styles.newsItem}>
                                    <img src="https://www.thinkfood.co.kr/news/photo/202304/97747_127797_28.jpg"alt="뉴스 이미지 2" className={styles.newsImage} />
                                    <div className={styles.newsContent}>
                                        <span className={styles.newsTitle}>빙그레, 단백질 음료 ‘더:단백’ 2년만에 누적판매 3000만개 돌파</span>
                                        <p className={styles.newsDescription}>새 모델로 박준형 내세워 공격적 마케팅 나서</p>
                                        <span className={styles.newsSource}>식품음료신문</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div className={styles.productInfoTable}>
                        <div className={styles.productInfoGrid}>
                            <div className={styles.productInfoRow}>
                                ...
                                <div className={styles.productInfoCellContent} id="product-number">1996050200349</div>
                            ...
                            <div className={styles.productInfoRow}>
                                ...
                                <div className={styles.productInfoCellContent} id="manufacturer">(주)자연과사람들</div>
                                <div className={styles.productInfoCellHeader}>브랜드</div>
                                <div className={styles.productInfoCellContent} id="brand">(주)빙그레</div>
                            </div>
                            <div className={styles.productInfoRow}>
                                <div className={styles.productInfoCellHeader}>모델명</div>
                                <div className={styles.productInfoCellContent} id="model-name">더단백 드링크 초코코</div>
                    ...
                    <div className={styles.productInfoTable}>
                        <div className={styles.productInfoGrid}>
                            ...
                            <div className={styles.productInfoRow}>
                                ...
                                <div className={styles.productInfoCellContent} id="ginseng-content">0.8g</div>
                            </div>
                            <div className={styles.productInfoRow}>
                ...
                <div className={styles.reviewSummaryBox}>
                    <div className={styles.reviewInfo}>
                        <div className={styles.rating}>
                            ...
                            <h2 className={styles.ratingAverage}>4.83 <span className={styles.averageRating}>/ 5</span></h2>
                        </div>
