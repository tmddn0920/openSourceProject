...
import reviewsData from './product7review.json';
            ...
            <div className={styles.container}>
                <div className={styles.mainContent}>
                    <div className={styles.productInfo}>
                        <h1 className={styles.productName}>얼라이브 원스데일리 포맨 멀티비타민 80정</h1>
                        <h2 className={styles.productCompany}>얼라이브</h2>
                        <div className={styles.productImageSection}>
                            <img id="product-image" className={styles.productImage} src="https://image7.coupangcdn.com/image/retail/images/38797201168226-701556db-e129-4283-bc19-bca7a345ab64.jpg" alt="제품 이미지" ref={productImageRef} />
                            ...
                            <div className={styles.subImages} ref={el => subImagesRef.current = el?.querySelectorAll('img') || null}>
                                <img src="https://image7.coupangcdn.com/image/retail/images/38797201168226-701556db-e129-4283-bc19-bca7a345ab64.jpg" alt="서브 이미지 1" />
                                <img src="https://image8.coupangcdn.com/image/retail/images/2341533662976704-69586ad0-3c0c-4769-bd90-bf99911ca6fd.jpg" alt="서브 이미지 2" />
                                <img src="https://image10.coupangcdn.com/image/retail/images/2376427370575987-d987d7a1-82dd-40be-abfc-d79fa85685cc.jpg" alt="서브 이미지 3" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className={styles.reviewNewsSection}>
                    <div className={styles.reviewSection}>
                        ...
                        <div id="reviews">
                            ...
                            <p className={styles.review}>"다양한 영양소를 한 알로 섭취할 수 있다"</p>
                            <p className={styles.review}>"비타민 특유의 냄새가 있다"</p>
                        </div>
                    ...
                    <div className={styles.relatedNews}>
                        ...
                        <ul id="news-list" className={styles.newsList}>
                            <li>
                                <a href="https://www.biotimes.co.kr/news/articleView.html?idxno=15945" id="news1" className={styles.newsItem}>
                                    <img src = "https://www.biotimes.co.kr/news/photo/202407/15945_21027_2815.jpg" alt="뉴스 이미지 1" className={styles.newsImage} />
                                    <div className={styles.newsContent}>
                                        <span className={styles.newsTitle}>얼라이브, 11번째 생일 맞이 역대급 프로모션 ‘열일한 당신을 위한 비타민 파티’ 진행</span>
                                        <p className={styles.newsDescription}>㈜네츄럴라이프(대표 김경락)가 얼라이브의 11주년을 기념해 ‘역대급 고객 사은 행사’를 진행</p>
                                        <span className={styles.newsSource}>바이오타임스</span>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a href="http://www.bosa.co.kr/news/articleView.html?idxno=2219412" id="news1" className={styles.newsItem}>
                                    <img src = "https://cdn.bosa.co.kr/news/photo/202403/2219412_252021_208.jpg" alt="뉴스 이미지 1" className={styles.newsImage} />
                                    <div className={styles.newsContent}>
                                        <span className={styles.newsTitle}>네츄럴라이프, 손자녀 돌보는 어르신에 멀티비타민 후원</span>
                                        <p className={styles.newsDescription}>한국노인종합복지관협회와 손잡고 ‘황혼 육아 응원 캠페인’ 진행</p>
                                        <span className={styles.newsSource}>의학신문</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div className={styles.productInfoTable}>
                        <div className={styles.productInfoGrid}>
                            ...
                            <div className={styles.productInfoRow}>
                                ...
                                <div className={styles.productInfoCellContent} id="manufacturer">-</div>
                                <div className={styles.productInfoCellHeader}>브랜드</div>
                                <div className={styles.productInfoCellContent} id="brand">네츄럴라이프</div>
                            </div>
                            <div className={styles.productInfoRow}>
                                <div className={styles.productInfoCellHeader}>모델명</div>
                                <div className={styles.productInfoCellContent} id="model-name">얼라이브! 원스데일리</div>
