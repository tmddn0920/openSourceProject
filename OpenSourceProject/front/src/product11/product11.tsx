...
import reviewsData from './product11review.json';
            ...
            <div className={styles.container}>
                <div className={styles.mainContent}>
                    <div className={styles.productInfo}>
                        <h1 className={styles.productName}>종근당건강 아임비타 멀티비타민 이뮨샷 30병</h1>
                        <h2 className={styles.productCompany}>종근당</h2>
                        <div className={styles.productImageSection}>
                            <img id="product-image" className={styles.productImage} src="https://shop-phinf.pstatic.net/20240812_20/1723418139612dbOq3_JPEG/25351412442268394_1851377336.jpg?type=m510" alt="제품 이미지" ref={productImageRef} />
                            ...
                            <div className={styles.subImages} ref={el => subImagesRef.current = el?.querySelectorAll('img') || null}>
                                <img src="https://shop-phinf.pstatic.net/20240812_20/1723418139612dbOq3_JPEG/25351412442268394_1851377336.jpg?type=m510" alt="서브 이미지 1" />
                                <img src="https://image10.coupangcdn.com/image/vendor_inventory/ae4b/682d79c474950766bd8f25c060d5dd47ebaa5b1d66e7af17b41b79d350ed.jpg" alt="서브 이미지 2" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className={styles.reviewNewsSection}>
                    <div className={styles.reviewSection}>
                        ...
                        <div id="reviews">
                            <p className={styles.review}>"하나씩 섭취하기 편리하다"</p>
                            <p className={styles.review}>"비타민이 풍부하다"</p>
                            <p className={styles.review}>"포장이 잘 되어 있다"</p>
                        </div>
                    ...
                    <div className={styles.relatedNews}>
                        ...
                        <ul id="news-list" className={styles.newsList}>
                            <li>
                                <a href="https://www.etnews.com/20240628000080" id="news1" className={styles.newsItem}>
                                    <img src = "https://img.etnews.com/news/article/2024/06/28/news-p.v1.20240628.f24bdbeb7e184d6092ff60994aadb3b7_P1.jpg" alt="뉴스 이미지 1" className={styles.newsImage} />
                                    <div className={styles.newsContent}>
                                        <span className={styles.newsTitle}>종근당건강 아임비타, 채널A '티처스' 메인 스폰서 참여</span>
                                        <p className={styles.newsDescription}>종근당건강이 채널A 예능 프로그램 '성적을 부탁해-티처스'의 메인 스폰서로 참여해 '아임비타 멀티비타민 이뮨샷'을 지원한다고 밝혔다.</p>
                                        <span className={styles.newsSource}>전자신문</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div className={styles.productInfoTable}>
                        <div className={styles.productInfoGrid}>
                            ...
                            <div className={styles.productInfoRow}>
                                ...
                                <div className={styles.productInfoCellContent} id="manufacturer">(주)네추럴웨이</div>
                                <div className={styles.productInfoCellHeader}>브랜드</div>
                                <div className={styles.productInfoCellContent} id="brand">(주)종근당건강</div>
                            </div>
                            <div className={styles.productInfoRow}>
                                <div className={styles.productInfoCellHeader}>모델명</div>
                                <div className={styles.productInfoCellContent} id="model-name">멀티비타민 이뮨 샷</div>
                    ...
                    <div className={styles.productInfoTable}>
                        <div className={styles.productInfoGrid}>
                            ...
                            <div className={styles.productInfoRow}>
                                ...
                                <div className={styles.productInfoCellContent} id="solid-content">1병</div>
                ...
                <div className={styles.reviewSummaryBox}>
                    <div className={styles.reviewInfo}>
                        <div className={styles.rating}>
                            ...
                            <h2 className={styles.ratingAverage}>4.92 <span className={styles.averageRating}>/ 5</span></h2>
                        </div>
                        <div className={styles.reviewCount}>
                            ...
                            <span id="review-count" className={styles.reviewCountNumber}>520</span>
                        </div>
