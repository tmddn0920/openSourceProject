...
import reviewsData from './product9review.json';
            ...
            <div className={styles.container}>
                <div className={styles.mainContent}>
                    <div className={styles.productInfo}>
                        <h1 className={styles.productName}>고려은단 멀티비타민 올인원 60캡슐, 3개</h1>
                        <h2 className={styles.productCompany}>고려은단</h2>
                        <div className={styles.productImageSection}>
                            <img id="product-image" className={styles.productImage} src="https://shop-phinf.pstatic.net/20230706_241/16886246253830PaSi_JPEG/13252469203366447_1419774283.jpg?type=m510" alt="제품 이미지" ref={productImageRef} />
                            ...
                            <div className={styles.subImages} ref={el => subImagesRef.current = el?.querySelectorAll('img') || null}>
                                <img src="https://shop-phinf.pstatic.net/20230706_241/16886246253830PaSi_JPEG/13252469203366447_1419774283.jpg?type=m510" alt="서브 이미지 1" />
                                <img src="https://image7.coupangcdn.com/image/0820_amir_esrgan_inf80k_batch_0_max3k/9b02/f64dca8749c9cfc356ec066014ff6a8e53bdd449abee0984c7bbd05e10c8.jpg" alt="서브 이미지 2" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className={styles.reviewNewsSection}>
                    <div className={styles.reviewSection}>
                        ...
                        <div id="reviews">
                            <p className={styles.review}>"휴대성이 좋다"</p>
                    ...
                    <div className={styles.relatedNews}>
                        ...
                        <ul id="news-list" className={styles.newsList}>
                            <li>
                                <a href="https://www.globalepic.co.kr/view.php?ud=20240719104627585248439a4874_29" id="news1" className={styles.newsItem}>
                                    <img src = "https://cgeimage.commutil.kr/phpwas/restmb_allidxmake.php?pp=002&idx=3&simg=202407191046350599948439a487410625221173.jpg&nmt=29" alt="뉴스 이미지 1" className={styles.newsImage} />
                                    <div className={styles.newsContent}>
                                        <span className={styles.newsTitle}>고려은단, 썸머위크 특가 쇼핑라이브 진행</span>
                                        <p className={styles.newsDescription}>여름철 휴가 성수기를 맞아 건기식으로 간편하게 건강을 챙기고자 하는 니즈 공략</p>
                                        <span className={styles.newsSource}>글로벌에픽뉴스</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div className={styles.productInfoTable}>
                        <div className={styles.productInfoGrid}>
                            ...
                            <div className={styles.productInfoRow}>
                                ...
                                <div className={styles.productInfoCellContent} id="manufacturer">고려은단헬스케어</div>
                                <div className={styles.productInfoCellHeader}>브랜드</div>
                                <div className={styles.productInfoCellContent} id="brand">고려은단</div>
                            </div>
                            <div className={styles.productInfoRow}>
                                <div className={styles.productInfoCellHeader}>모델명</div>
                                <div className={styles.productInfoCellContent} id="model-name">고려은단 멀티비타민 올인원</div>
                ...
                <div className={styles.reviewSummaryBox}>
                    <div className={styles.reviewInfo}>
                        <div className={styles.rating}>
                            ...
                            <h2 className={styles.ratingAverage}>4.88 <span className={styles.averageRating}>/ 5</span></h2>
                        </div>
                        <div className={styles.reviewCount}>
                            ...
                            <span id="review-count" className={styles.reviewCountNumber}>2000</span>
                        </div>
