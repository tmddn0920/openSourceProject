...
import reviewsData from './product3review.json';
            ...
            <div className={styles.container}>
                <div className={styles.mainContent}>
                    <div className={styles.productInfo}>
                        <h1 className={styles.productName}>블루다이아몬드 아몬드 브리즈 뉴트리플러스 프로틴 190ml 48개</h1>
                        <h2 className={styles.productCompany}>블루다이아몬드</h2>
                        <div className={styles.productImageSection}>
                            <img id="product-image" className={styles.productImage} src="https://image6.coupangcdn.com/image/retail/images/3565495096119914-4be83c18-d9f3-483d-879a-19eeccc0c8c3.jpg" alt="제품 이미지" ref={productImageRef} />
                            ...
                            <div className={styles.subImages} ref={el => subImagesRef.current = el?.querySelectorAll('img') || null}>
                                <img src="https://image6.coupangcdn.com/image/retail/images/3565495096119914-4be83c18-d9f3-483d-879a-19eeccc0c8c3.jpg" alt="서브 이미지 1" />
                                <img src="https://thumbnail6.coupangcdn.com/thumbnails/remote/230x230ex/image/vendor_inventory/1e2f/dc00bb9b3ef676df5848431f944a4c544b92902a4f08914fcc42d833ea0e.png" alt="서브 이미지 2" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className={styles.reviewNewsSection}>
                    <div className={styles.reviewSection}>
                        ...
                        <div id="reviews">
                            <p className={styles.review}>"부드럽고 고소하다"</p>
                            <p className={styles.review}>"저당, 저지방으로 건강에 유익하다"</p>
                            <p className={styles.review}>"맛이 덜 자극적이다"</p>
                        </div>
                    ...
                    <div className={styles.relatedNews}>
                        ...
                        <ul id="news-list" className={styles.newsList}>
                            <li>
                                <a href="https://theguru.co.kr/mobile/article.html?no=69540" id="news1" className={styles.newsItem}>
                                    <img src = "https://www.theguru.co.kr/data/photos/20240416/art_17132304693971_1295c6.jpg" alt="뉴스 이미지 1" className={styles.newsImage} />
                                    <div className={styles.newsContent}>
                                        <span className={styles.newsTitle}>매일유업 '아몬드브리즈', 美 영영사 픽 '최고의 아몬드우유'…2년 연속</span>
                                        <p className={styles.newsDescription}>낮은 열량·풍부한 영양성분 등 호평</p>
                                        <span className={styles.newsSource}>더구루</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div className={styles.productInfoTable}>
                        <div className={styles.productInfoGrid}>
                            <div className={styles.productInfoRow}>
                                ...
                                <div className={styles.productInfoCellContent} id="product-number">19810227007918</div>
                            ...
                            <div className={styles.productInfoRow}>
                                ...
                                <div className={styles.productInfoCellContent} id="manufacturer">(주)매일유업</div>
                                <div className={styles.productInfoCellHeader}>브랜드</div>
                                <div className={styles.productInfoCellContent} id="brand">블루다이아몬드</div>
                            </div>
                            <div className={styles.productInfoRow}>
                                <div className={styles.productInfoCellHeader}>모델명</div>
                                <div className={styles.productInfoCellContent} id="model-name">아몬드브리즈 뉴트리플러스 프로틴</div>
                    ...
                    <div className={styles.productInfoTable}>
                        <div className={styles.productInfoGrid}>
                            ...
                            <div className={styles.productInfoRow}>
                                ...
                                <div className={styles.productInfoCellContent} id="solid-content">4.2g</div>
                                <div className={styles.productInfoCellHeader}>당류 함량</div>
                                <div className={styles.productInfoCellContent} id="ginseng-content">5.1g</div>
                            </div>
                            <div className={styles.productInfoRow}>
