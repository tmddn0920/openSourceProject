...
import reviewsData from './product10review.json';
            ...
            <div className={styles.container}>
                <div className={styles.mainContent}>
                    <div className={styles.productInfo}>
                        <h1 className={styles.productName}>종근당 이뮨 듀오 멀티 비타맥스 2박스</h1>
                        <h2 className={styles.productCompany}>종근당</h2>
                        <div className={styles.productImageSection}>
                            <img id="product-image" className={styles.productImage} src="https://shop-phinf.pstatic.net/20230105_138/1672895111102emOAo_JPEG/197794979926097_1035474786.jpg?type=m510" alt="제품 이미지" ref={productImageRef} />
                            ...
                            <div className={styles.subImages} ref={el => subImagesRef.current = el?.querySelectorAll('img') || null}>
                                <img src="https://shop-phinf.pstatic.net/20230105_138/1672895111102emOAo_JPEG/197794979926097_1035474786.jpg?type=m510" alt="서브 이미지 1" />
                                <img src="https://image6.coupangcdn.com/image/retail/images/3366065567300802-fe24ac5f-d0d7-4199-a454-a9131b8286fa.jpg" alt="서브 이미지 2" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className={styles.reviewNewsSection}>
                    <div className={styles.reviewSection}>
                        ...
                        <div id="reviews">
                            ...
                            <p className={styles.review}>"영양소가 풍부하다"</p>
                            <p className={styles.review}>"비타민 맛이 강하다"</p>
                        </div>
                    ...
                    <div className={styles.relatedNews}>
                        ...
                        <ul id="news-list" className={styles.newsList}>
                            <li>
                                <a href="https://www.industrynews.co.kr/news/articleView.html?idxno=54928" id="news1" className={styles.newsItem}>
                                    <img src = "https://www.industrynews.co.kr/news/photo/202408/54928_62083_5539.jpg" alt="뉴스 이미지 1" className={styles.newsImage} />
                                    <div className={styles.newsContent}>
                                        <span className={styles.newsTitle}>종근당, ‘이뮨듀오 멀티비타맥스’ 1000만병 돌파 기념 이벤트 진행</span>
                                        <p className={styles.newsDescription}>비타민B군 고함량 배합… 3중 복합 제형의 올인원 멀티비타민</p>
                                        <span className={styles.newsSource}>인더스트리뉴스</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div className={styles.productInfoTable}>
                        <div className={styles.productInfoGrid}>
                            ...
                            <div className={styles.productInfoRow}>
                                ...
                                <div className={styles.productInfoCellContent} id="brand">종근당</div>
                            </div>
                            <div className={styles.productInfoRow}>
                                <div className={styles.productInfoCellHeader}>모델명</div>
                                <div className={styles.productInfoCellContent} id="model-name">이뮨 듀오 멀티비타맥스</div>
                ...
                <div className={styles.reviewSummaryBox}>
                    <div className={styles.reviewInfo}>
                        <div className={styles.rating}>
                            ...
                            <h2 className={styles.ratingAverage}>4.87 <span className={styles.averageRating}>/ 5</span></h2>
                        </div>
                        <div className={styles.reviewCount}>
                            ...
                            <span id="review-count" className={styles.reviewCountNumber}>780</span>
                        </div>
