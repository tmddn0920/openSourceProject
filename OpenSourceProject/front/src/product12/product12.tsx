...
import reviewsData from './product12review.json';
            ...
            <div className={styles.container}>
                <div className={styles.mainContent}>
                    <div className={styles.productInfo}>
                        <h1 className={styles.productName}>덴프스 트루바이타민I 3개월분</h1>
                        <h2 className={styles.productCompany}>덴프스</h2>
                        <div className={styles.productImageSection}>
                            <img id="product-image" className={styles.productImage} src="https://shop-phinf.pstatic.net/20240820_159/1724113399632nxhgN_JPEG/8275413440897783_1177918732.jpg?type=m510" alt="제품 이미지" ref={productImageRef} />
                            ...
                            <div className={styles.subImages} ref={el => subImagesRef.current = el?.querySelectorAll('img') || null}>
                                <img src="https://shop-phinf.pstatic.net/20240820_159/1724113399632nxhgN_JPEG/8275413440897783_1177918732.jpg?type=m510" alt="서브 이미지 1" />
                                <img src="https://image7.coupangcdn.com/image/retail/images/2440436838759784-239fcc54-1304-4d24-8d97-ea6aa05c1798.jpg" alt="서브 이미지 2" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className={styles.reviewNewsSection}>
                    <div className={styles.reviewSection}>
                        ...
                        <div id="reviews">
                            <p className={styles.review}>"여러 알을 섭취해야한다"</p>
                            <p className={styles.review}>"비타민이 풍부하다"</p>
                            <p className={styles.review}>"한 포씩 포장되어 있다"</p>
                        </div>
                    ...
                    <div className={styles.relatedNews}>
                        ...
                        <ul id="news-list" className={styles.newsList}>
                            <li>
                                <a href="https://www.newspim.com/news/view/20221213000113" id="news1" className={styles.newsItem}>
                                    <img src = "https://img.newspim.com/news/2022/12/13/2212130909426060.jpg" alt="뉴스 이미지 1" className={styles.newsImage} />
                                    <div className={styles.newsContent}>
                                        <span className={styles.newsTitle}>에이치피오, 10주년 기념 비타민 '트루바이타민 부스터' 출시</span>
                                        <p className={styles.newsDescription}>건강기능식품 기업 에이치피오는 10주년을 맞이해 비타민 제품 '트루바이타민'의 에디션인 트루바이타민 부스터(Booster)를 출시했다고 13일 밝혔다.</p>
                                        <span className={styles.newsSource}>뉴스핌</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div className={styles.productInfoTable}>
                        <div className={styles.productInfoGrid}>
                            ...
                            <div className={styles.productInfoRow}>
                                ...
                                <div className={styles.productInfoCellContent} id="manufacturer">(주)노바렉스</div>
                                <div className={styles.productInfoCellHeader}>브랜드</div>
                                <div className={styles.productInfoCellContent} id="brand">(주)에이치피오</div>
                            </div>
                            <div className={styles.productInfoRow}>
                                <div className={styles.productInfoCellHeader}>모델명</div>
                                <div className={styles.productInfoCellContent} id="model-name">트루바이타민 I</div>
                    ...
                    <div className={styles.productInfoTable}>
                        <div className={styles.productInfoGrid}>
                            ...
                            <div className={styles.productInfoRow}>
                                ...
                                <div className={styles.productInfoCellContent} id="solid-content">1포</div>
                                <div className={styles.productInfoCellHeader}>주요 성분</div>
                                <div className={styles.productInfoCellContent} id="ginseng-content">멀티비타민</div>
                            </div>
                            <div className={styles.productInfoRow}>
                ...
                <div className={styles.reviewSummaryBox}>
                    <div className={styles.reviewInfo}>
                        <div className={styles.rating}>
                            ...
                            <h2 className={styles.ratingAverage}>4.89 <span className={styles.averageRating}>/ 5</span></h2>
                        </div>
                        <div className={styles.reviewCount}>
                            ...
                            <span id="review-count" className={styles.reviewCountNumber}>4200</span>
                        </div>
